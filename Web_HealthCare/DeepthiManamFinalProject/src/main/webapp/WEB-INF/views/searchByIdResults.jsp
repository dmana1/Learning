...
<body>
	<div class="container">
		...
		<br>
		<form action ="showCreateEncounter.htm" method = "post">
		<div class="row">
		<div class="col-sm-8"><p></p></div>
				<div class="col-sm-2">
				<input type="submit" name="submit" value="Create Encounter"
				class="btn btn-info" /></div>
				
				<div class="col-sm-1">
				<input type="submit"
					onclick="this.form.action='encounterPdf.htm'"
					value="Generate PDF" class="btn btn-info" /></div></div>
