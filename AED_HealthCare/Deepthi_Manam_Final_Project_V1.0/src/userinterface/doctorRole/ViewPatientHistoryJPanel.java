...
public class ViewPatientHistoryJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewPatientHistoryJPanel(HealthCareSystem system, JPanel userProcessContainer, Enterprise enterprise, Organization organization, UserAccount userAccount,
            ...
            ArrayList<LabTest> completeLabTestList, int requestNo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        addAdverseJButton = new javax.swing.JButton();
        ...
        addLabTestJButton = new javax.swing.JButton();
        ...
        addEncounterJButton.setText("Add Medication And VitalSign");
        ...
        addAdverseJButton.setBackground(new java.awt.Color(137, 185, 239));
        addAdverseJButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        addAdverseJButton.setText("Report Adverse Events");
        addAdverseJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                addAdverseJButtonActionPerformed(evt);
            }
        });
        ...
        closeJButton.setBackground(new java.awt.Color(137, 185, 239));
        ...
        addLabTestJButton.setBackground(new java.awt.Color(137, 185, 239));
        addLabTestJButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        addLabTestJButton.setText("Add Lab Tests");
        addLabTestJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                addLabTestJButtonActionPerformed(evt);
            }
        });

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel5.setText("Lab Tests");
        ...
        viewRequestsJButton.setBackground(new java.awt.Color(137, 185, 239));
        viewRequestsJButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        viewRequestsJButton.setText("View Requests Sent For Patient");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(205, 205, 205)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(addAdverseJButton, javax.swing.GroupLayout.DEFAULT_SIZE, 343, Short.MAX_VALUE)
                                    ...
                                    .addComponent(addLabTestJButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(viewRequestsJButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(refreshAdverseJButton, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(27, 27, 27)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(addAdverseJButton)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(addAllergyJButton)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(addLabTestJButton)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void closeJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_closeJButtonActionPerformed
        ...
        //set the status of work requested to Completed/Closed.
        for(WorkRequest wr : ((DoctorOrganization)organization).getWorkQueue().getWorkRequestList() ){
            if(wr instanceof AppointmentRequest){
            AppointmentRequest apr = (AppointmentRequest)wr;
            ...
            if(apr.getRequestId() == HealthCareSystem.appointmentId)  {
                apr.setStatus("Completed");
           }
            }
       }
        //set the workrequest to 0, so that the case is completed
        HealthCareSystem.workRequestId = 0;
        
        //Go back to work area of doctor
         userProcessContainer.remove(this);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.previous(userProcessContainer);
    }//GEN-LAST:event_closeJButtonActionPerformed

    private void addAdverseJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addAdverseJButtonActionPerformed
        // TODO add your handling code here:
        AdverseEventOfPatientJPanel panel = new AdverseEventOfPatientJPanel(system,userProcessContainer,enterprise,organization, userAccount,patient);
        userProcessContainer.add("AdverseEventOfPatientJPanel", panel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    }//GEN-LAST:event_addAdverseJButtonActionPerformed

    private void addLabTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addLabTestJButtonActionPerformed
        // TODO add your handling code here:
        ...
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    }//GEN-LAST:event_addLabTestJButtonActionPerformed
    ...
    private void viewRequestsJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewRequestsJButtonActionPerformed
        // TODO add your handling code here:        
         ViewPatientInformationRequestsJPanel panel = new ViewPatientInformationRequestsJPanel(system,userProcessContainer,enterprise,organization, userAccount,requestNo);
        userProcessContainer.add("ViewPatientInformationRequestsJPanel", panel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
